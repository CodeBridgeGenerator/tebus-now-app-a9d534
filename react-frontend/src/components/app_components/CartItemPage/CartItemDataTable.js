...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.voucherId?.id}</p>
const dropdownTemplate2 = (rowData, { rowIndex }) => <p >{rowData.userId?.name}</p>
const badgeTemplate3 = (rowData, { rowIndex }) => <Badge value={Number(rowData.Quantity)}  />
...
<Column field="voucherId" header="VoucherId" body={dropdownTemplate1} filter={selectedFilterFields.includes("voucherId")} hidden={selectedHideFields?.includes("voucherId")}  style={{ minWidth: "8rem" }} />
<Column field="userId" header="UserId" body={dropdownTemplate2} filter={selectedFilterFields.includes("userId")} hidden={selectedHideFields?.includes("userId")}  style={{ minWidth: "8rem" }} />
<Column field="Quantity" header="Quantity" body={badgeTemplate3} filter={selectedFilterFields.includes("Quantity")} hidden={selectedHideFields?.includes("Quantity")}  sortable style={{ minWidth: "8rem" }} />
