...
import seederData from "./cartItem.seeder.json";
...
const CartItemSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CartItemSeederDialogComponent);
