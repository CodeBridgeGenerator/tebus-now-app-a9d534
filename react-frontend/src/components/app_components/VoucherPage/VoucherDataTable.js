...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.categoryId?.id}</p>
const badgeTemplate2 = (rowData, { rowIndex }) => <Badge value={Number(rowData.points)}  />
...
const inputTextareaTemplate5 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
...
<Column field="categoryId" header="CategoryId" body={dropdownTemplate1} filter={selectedFilterFields.includes("categoryId")} hidden={selectedHideFields?.includes("categoryId")}  style={{ minWidth: "8rem" }} />
<Column field="points" header="Points" body={badgeTemplate2} filter={selectedFilterFields.includes("points")} hidden={selectedHideFields?.includes("points")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="description" header="Description" body={inputTextareaTemplate5} filter={selectedFilterFields.includes("description")} hidden={selectedHideFields?.includes("description")}  sortable style={{ minWidth: "8rem" }} />
